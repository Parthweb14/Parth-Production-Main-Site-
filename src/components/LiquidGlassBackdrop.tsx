    ...
    <div className="absolute inset-0 overflow-hidden bg-[#050505]" aria-hidden>
      <div
        className={`absolute inset-0 ${
          cool
            ...
            : 'bg-[radial-gradient(ellipse_at_center,_rgba(58,143,184,0.08)_0%,_transparent_55%)]'
        }`}
      />
      ...
      <motion.div
        className={`liquid-orb liquid-orb-c absolute bottom-[-10%] left-[30%] h-[42vw] max-h-[400px] w-[42vw] max-w-[400px] rounded-full blur-[75px] md:blur-[110px] max-md:opacity-60 ${
          cool ? 'bg-zinc-300/20' : 'bg-[#050a12]/80'
        }`}
        animate={
          reduceMotion
            ? undefined
      ...
      <div
        ...
        style={{
          ...
          boxShadow: cool
            ...
            : 'inset 0 1px 0 rgba(255,255,255,0.12), inset 0 -1px 0 rgba(58,143,184,0.12)',
        }}
      />
