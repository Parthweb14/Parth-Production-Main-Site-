    ...
    <>
      ...
      <main className="relative overflow-x-hidden bg-black">
        ...
        <section id="connect" className="relative border-b border-white/10 py-14 md:py-20 scroll-mt-28">
          <div className="pointer-events-none absolute right-0 top-0 h-72 w-72 rounded-full bg-[#ff5a3c]/10 blur-3xl" />
          <div className="relative max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
            <motion.div
              initial={{ opacity: 0, y: 24 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="lg:col-span-5 relative overflow-hidden rounded-[28px] border border-[#ff5a3c]/35 bg-gradient-to-br from-[#ff5a3c]/20 via-black to-black p-7 md:p-9"
            >
              <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-[#ff5a3c]/30 blur-3xl" />
              <p className="text-[11px] uppercase tracking-[0.28em] text-[#ff5a3c] font-semibold mb-3">
                Fastest reply
              </p>
              ...
              <a
                ...
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#ff5a3c] px-6 py-3.5 text-xs font-bold uppercase tracking-[0.14em] text-white transition-all hover:scale-[1.03] hover:shadow-[0_0_28px_rgba(255,90,60,0.45)]"
              >
              ...
              <div className="mt-8 grid grid-cols-2 gap-3">
                <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                  <Clock3 className="h-4 w-4 text-[#ff5a3c] mb-2" />
                ...
                <div className="rounded-2xl border border-white/10 bg-black/40 p-4">
                  <Navigation className="h-4 w-4 text-[#ff5a3c] mb-2" />
              ...
              {channels.map((card, i) => {
                ...
                return (
                  <motion.a
                    ...
                    className="group relative flex items-center gap-4 md:gap-5 overflow-hidden rounded-[22px] border border-white/10 bg-white/[0.03] p-5 md:p-6 transition-all duration-300 hover:border-[#ff5a3c]/45 hover:bg-white/[0.05]"
                  >
                    <div className="absolute inset-y-0 left-0 w-px bg-gradient-to-b from-transparent via-[#ff5a3c]/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-2xl border border-[#ff5a3c]/30 bg-[#ff5a3c]/10 text-[#ff5a3c] transition-colors group-hover:bg-[#ff5a3c] group-hover:text-black">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-lg md:text-xl font-semibold text-white group-hover:text-[#ff5a3c] transition-colors break-words">
                        {card.primary}
                      </p>
                      <p className="mt-1 text-sm text-white/50">{card.secondary}</p>
                    </div>
                    <ArrowUpRight className="h-5 w-5 flex-shrink-0 text-white/30 transition-all group-hover:text-[#ff5a3c] group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                  </motion.a>
                );
              })}
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-8 flex flex-col md:flex-row md:items-end md:justify-between gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-white/20 px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.14em] text-white transition-all hover:border-[#ff5a3c]/50 hover:bg-white/5"
              >
                Open directions
                <ArrowUpRight className="h-4 w-4" />
              </a>
            ...
            >
              <div className="relative overflow-hidden rounded-[22px] border border-white/10 min-h-[360px] md:min-h-[480px]">
                ...
                <div className="absolute top-4 left-4 right-4 flex items-center justify-between gap-3 pointer-events-none">
                  <span className="inline-flex items-center gap-2 rounded-full border border-[#ff5a3c]/35 bg-black/70 backdrop-blur px-3 py-1.5 text-[10px] uppercase tracking-[0.2em] text-[#ff5a3c] font-semibold">
                    <span className="h-1.5 w-1.5 rounded-full bg-[#ff5a3c] animate-pulse" />
